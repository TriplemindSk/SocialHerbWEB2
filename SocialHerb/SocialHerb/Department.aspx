<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="Department.aspx.vb" Inherits="SocialHerb.Department" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        หน่วยงานที่เกี่ยวข้องกับสมุนไพร</h2>
    <div style="float: right; margin-left: 5px; margin-bottom: 10px;">
        ...
        <asp:HyperLink ID="hpDepartment" runat="server" align="center" ForeColor="#827717"
            Font-Bold="true" Width="100%" Height="25px" Style="text-align: center">Add New Department</asp:HyperLink>
    </div>
    <dx:ASPxGridView ID="gv_DepartmentShow" ClientInstanceName="gv_DepartmentShow" runat="server"
        AutoGenerateColumns="False" EnableRowsCache="false" DataSourceID="Department_SH"
        KeyFieldName="ID" Width="100%" Style="text-align: center" Enabled="True">
        <Columns>
            <dx:GridViewDataColumn FieldName="contactName" VisibleIndex="0" Caption="ชื่อหน่วยงาน"
                ReadOnly="True" SortOrder="Descending" HeaderStyle-HorizontalAlign="Center" Width="150px">
                <EditCellStyle HorizontalAlign="Center">
                </EditCellStyle>
                <DataItemTemplate>
                    <asp:LinkButton ID="lnk_DEname" runat="server" Text='<%# Eval("contactName") %>'
                        CommandArgument='<%# Eval("ID") %>' OnCommand="ListItem_Command" Enabled="True"
                        CommandName="OpenCreateDepartment">
                    </asp:LinkButton>
                </DataItemTemplate>
                <EditItemTemplate>
            ...
            <dx:GridViewDataColumn FieldName="Address" VisibleIndex="1" Caption="ที่อยู่" ReadOnly="True"
            ...
            <dx:GridViewDataColumn FieldName="Role" VisibleIndex="2" Caption="บทบาทหน้าที่" ReadOnly="True"
                HeaderStyle-HorizontalAlign="Center" Width="300px" Visible="false">
                <EditCellStyle HorizontalAlign="Center">
                </EditCellStyle>
                <EditItemTemplate>
            ...
            <dx:GridViewDataColumn FieldName="website" VisibleIndex="3" Caption="Website" ReadOnly="True"
    ...
    <asp:SqlDataSource ID="Department_SH" runat="server" ConnectionString="<%$ ConnectionStrings:SocialHerb %>"
        SelectCommand=" SELECT ID,contactName,Address,Role,website,date
                    FROM Contact ORDER BY [date] DESC"></asp:SqlDataSource>
    <br />
    <br />
    <br />
    <br />
